function [Reflectance_Cal, Mice_Num, Truth] = function_calibrate(Truth_Name,Image_Name,White_Name,Dark_Name, Results_Folder, w, Figures);
...
w_interest = round(z_size/2);%find(w == 700);
if Figures == 1
